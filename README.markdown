...
The following is a demonstration of the interpretation and compilation of a PL/0 program that calculates the factorial of the number 6.
...
#### Compile to TAM bytecode:

<pre>
$> scala de.jetho.pl0compiler.PL0Compiler factorial.pl0 fact.obj
</pre>

#### Use TAM Disassembler to display the generated bytecode:
<pre>
...
#### Run the program with the TAM Interpreter:
